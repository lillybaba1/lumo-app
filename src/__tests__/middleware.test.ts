...
describe('auth middleware routing', () => {
  it('allows visiting login when a stale session cookie exists', () => {
  ...
  it('redirects protected admin paths to login when no session is present', () => {
  ...
  it('allows protected admin paths when a session cookie exists', () => {
